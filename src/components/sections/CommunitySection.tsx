        ...
        <div className="flex flex-col items-center gap-8 md:gap-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 w-full">
            {data.cards.map((card) => (
              <article
                key={card.id}
                className="flex flex-col items-center text-center gap-4 sm:gap-5 p-5 sm:p-6 lg:p-8 bg-white rounded-[var(--radius-card)] transition-shadow duration-300 hover:shadow-card-hover"
